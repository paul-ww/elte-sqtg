...
public class LandingPageTest {
    ...
    public void testFormFilling() {
        LandingPage landingPage = new LandingPage(this.driver);
        landingPage.fillAllForms(this.sampleEventName, this.sampleDateType, this.sampleWeekDays,
    ...
    public void testCreateEvent() {
        LandingPage landingPage = new LandingPage(this.driver);
        EventPage myEventPage = landingPage.createEvent(this.sampleEventName, this.sampleDateType, this.sampleWeekDays,
                this.sampleTimeEarliest, this.sampleTimeLatest);
