...
public class EventPageTest {
    ...
    public void testMultiPersonAvailability() {
        ...
        EventPage firstUserEventPage = firstLandingPage.createEvent(this.sampleEventName, this.sampleDateType, this.sampleWeekDays, this.sampleTimeEarliest, this.sampleTimeLatest);
